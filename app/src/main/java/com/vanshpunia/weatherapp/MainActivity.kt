...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityName: String) {
        ...
        val response =
            retrofit.getWeatherData(cityName, "a781b0f59ce3888d0802fac2ee68cada", "metric")
        response.enqueue(object : Callback<WeatherApp> {
            ...
            override fun onResponse(call: Call<WeatherApp>, response: Response<WeatherApp>) {
                ...
                if (responseBody != null && response.isSuccessful) {
                    ...
                    binding.windSpeed.text = "${responseBody.wind.speed.toString()}" + "mph"
...
//                    binding.conditionIcon.setImageResource(responseBody.weather.firstOrNull()?.icon?: "unknown")
                    ...
                    changeBackground(
                        ...
                        binding.sunset.text.toString(),
                        binding.sunrise.text.toString()
                    )
                }
            }
    ...
    private fun changeBackground(weather: String, sunset: String, sunrise: String) {
        binding.city.setTextColor(Color.BLACK)
        ...
        binding.textView14.setTextColor(Color.BLACK)
        binding.textView13.setTextColor(Color.BLACK)
        when (weather) {
            "Rain", "Drizzle" -> {
